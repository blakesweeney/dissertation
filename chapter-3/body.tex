...
From these examples we can see there are four requirements for each EC\@.
\begin{description}
...
connected by sequence, which would be separated by GD\@. Upon using GD this EC
is partitioned into for EC, one of which is shown in
