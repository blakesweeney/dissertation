...
\begin{table}
  \begin{tabulary}{\linewidth}{LRRRRRRRRR}
    \toprule
                & \multicolumn{3}{c}{Short Range}               & & \multicolumn{4}{c}{Short Range} & \\
...
\begin{table}
  % \includegraphics{chapter-1/figs/
...
than \textasciitilde 20 nts) and therefore can evolve independently in unrelated
...
\begin{table}
  \begin{tabulary}{\linewidth}{LRRRRRR}
    \toprule
    Basepair Family & \multicolumn{2}{c}{Local Interactions} & \multicolumn{2}{c}{Long-range Interactions} & \multicolumn{2}{c}{All Interactions} \\
